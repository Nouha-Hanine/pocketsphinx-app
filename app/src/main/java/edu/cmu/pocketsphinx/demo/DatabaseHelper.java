...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void insertInitialData(SQLiteDatabase db) {
        insertJoke(db,"Why did the chicken cross the road? To get to the other side.");
        insertJoke(db,"What do you call cheese that isn't yours? Nacho cheese.");
        insertJoke(db,"What did 0 say to 8? Nice belt!.");
        insertJoke(db,"What does a spy do when he is cold? He goes undercover.");
        insertJoke(db,"What do you call a sad cup of coffee? Depresso.");
        insertJoke(db," What did 50 Cent do when he was hungry? 58!");
        insertJoke(db,"What does a baby computer call his father? Data!");
        insertJoke(db,"How do celebrities stay cool? They have many fans.");
        insertJoke(db,"Why was six afraid of seven? Because 7-8-9");
        insertJoke(db,"What do you call a magician that looses his magic? Ian.");


        insertTimetableEntry(db,"is", "Tuesday", "11:30 AM", "Td Room 12");
        insertTimetableEntry(db,"rip", "Monday", "08:30 AM", "Td Room 9");
        insertTimetableEntry(db,"is", "Monday", "10:00 AM", "Td Room 7");
        insertTimetableEntry(db,"rip", "Monday", "11:30 AM", "Lab 2");
        insertTimetableEntry(db,"iam", "Monday", "14:00 PM", "Td Room 5");
        insertTimetableEntry(db,"abd", "Monday", "15:30 PM", "Td Room 20");


        insertTimetableEntry(db,"ro", "Tuesday", "08:00 AM", "Amphi 1");
        insertTimetableEntry(db,"ro", "Tuesday", "09:30 AM", "Lab 1");
        insertTimetableEntry(db,"is", "Tuesday", "11:30 AM", "Td Room 12");

        insertTimetableEntry(db,"rip", "Wednesday", "08:00 PM", "amphi 1");
        insertTimetableEntry(db,"comp", "Wednesday", "10:00 AM", "Td Room 18");
        insertTimetableEntry(db,"gl2", "Wednesday", "14:00 PM", "Td Room 19");
        insertTimetableEntry(db,"rip", "Wednesday", "16:00 PM", "Lab 2");

        insertTimetableEntry(db,"abd", "Thursday", "09:00 AM", "Td Room 22");
        insertTimetableEntry(db,"iam", "Thursday", "11:30 AM", "Td Room 30");
        insertTimetableEntry(db,"ro", "Thursday", "14:00 PM", "Lab 1");

        insertTimetableEntry(db,"is", "Saturday", "10:00 AM", "Td Room 3");
        insertTimetableEntry(db,"comp", "Saturday", "13:00 PM", "Td Room 10");
        insertTimetableEntry(db,"gl2", "Saturday", "15:00 PM", "Amphi 2");
    ...
    public void insertJoke(SQLiteDatabase db,String content) {
    ...
    public void insertTimetableEntry(SQLiteDatabase db,String subject,String day ,String time , String room) {
        // SQLiteDatabase db = getWritableDatabase();
        ContentValues contentValues = new ContentValues();
